...
while (true)
{
    ...
    do
    {
        ...
        else if (data.Date == new DateTime(2023, 10, 30))
        {
            Console.Clear();
            Console.WriteLine(data);
            Console.WriteLine("Что сегодня будешь делать?");
            Console.WriteLine("   1.Купить рик оуенс");
            Console.WriteLine("   2.Купить ветмо");
            Console.WriteLine("   3.Посмотреть лололошку");
            Console.WriteLine("   4.Пойти погулять");
        }
        else if (data.Date != new DateTime(2023, 10, 20))
        {
            Console.Clear();
